...
type LayoutRouteId = RouteId | "/" | "/about" | "/android" | "/auth" | "/comment/[commentID]" | "/compose" | "/iOS" | "/legal/privacy" | "/legal/refund" | "/legal/terms" | "/post/[postID]" | "/search" | "/settings" | "/settings/profile" | "/shipping" | "/[...catchAll]" | "/[publicID]" | "/[publicID]/edit" | "/[publicID]/edit/comment" | null
type LayoutParams = RouteParams & { commentID?: string,postID?: string,catchAll?: string,publicID?: string }
