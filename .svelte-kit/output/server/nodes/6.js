import * as universal from '../entries/pages/comment/_commentID_/_page.js';

export const index = 6;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/comment/_commentID_/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/comment/[commentID]/+page.js";
