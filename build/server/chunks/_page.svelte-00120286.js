...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1biw60w_START -->${$$result.title = `<title>${escape(data.post.title)}</title>`, ""}<link rel="canonical" href="${"https://satirigal.com/post/$" + escape(data.post.url, true)}"><meta name="description" content="satirigal.com"><!-- HEAD_svelte-1biw60w_END -->`, ""}
${validate_component(FullPost, "FullPost").$$render($$result, { post: data.post, profile }, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-00120286.js.map
